  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-card border border-border rounded-xl shadow-sm p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
        ...
        <h3 className="text-lg font-bold text-foreground">Quotations Dashboard</h3>
        <p className="text-muted-foreground mt-2 max-w-md">A detailed log of all quotes you have submitted, their current evaluation status, and historical win/loss ratios.</p>
      </div>
    </div>
  );
}

  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-card border border-border rounded-xl shadow-sm p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
        ...
        <h3 className="text-lg font-bold text-foreground">Accounts Receivable</h3>
        <p className="text-muted-foreground mt-2 max-w-md">Upload invoices against completed POs and track payment clearance dates in real time.</p>
      </div>
    </div>
  );
}
